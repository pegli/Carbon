...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','appersonlabs.carbon.js')
	...
	f = os.path.join(cwd,'Classes','AppersonlabsCarbonModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','appersonlabs.carbon.js']
